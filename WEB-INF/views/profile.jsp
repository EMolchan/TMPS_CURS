...
<script>
    ...
    function doCheck2() {
        var inputText1 = $("#newpasswordcashier").val();
        var inputText2 = $("#conformpasswordcashier").val();
        if(inputText2.length > 0 || inputText1.length > 0) {
            if (inputText1 == inputText2) {
                $('#message1').html('Matching').css('color', 'green');
                $("#updatebutton1").prop("disabled",false);
            } else {
                $('#message1').html('Not Matching').css('color', 'red');
                $("#updatebutton1").prop("disabled",true);
            }
        }else{
            $('#message1').html('').css('color', 'black');
            $("#updatebutton1").prop("disabled",false);
        }
    }
    ...
    function hide1() {
        if($("#add-cashier-form-update").hasClass("is-active")){
            $('#add-cashier-form-update').removeClass('is-active');
        }
    }

//    function checkaddUserStatus2() {
//        if($("#add-cashier-form-update").hasClass("is-active")){
//            $('#add-cashier-form-update').removeClass('is-active');
//        }else{
//            $('#add-cashier-form-update').addClass('is-active');
//        }
//    }
    ...
    function doAjax(inputText) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                $('#idcashier').val(data.id);
                $('#idcashier2').val(data.id);
                $('#rolecashier').val(data.role.name);
                $('#logincashier').val(data.login);
                $('#usernamecashier').val(data.name);
            }
        });
    }
</script>
                        ...
                        <div class="card card-user">
                            ...
                            <div class="text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="loaditems"><h5><%out.print(itemsList.size());%><br /><small>Items</small></h5></a>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="header">
                                <h4 class="title">Cashiers
                                    <span id="statusicon" class="pull-right">
                                        <i class="ti-plus" title="Push + button for add or push x button for close." onclick="checkaddUserStatus()"></i>
                                    </span>
                                </h4>
                                    ...
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-5 text-right">
                                                <%--<btn onclick="location.href='edituser';" ></btn>--%>
                                                <button onclick="doAjax(<%out.print(u.getId());%>)" id="idcasher" class="btn btn-sm btn-success btn-icon"><i class="fa fa-pencil-square-o"></i></button>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="copyright pull-center">
                    &copy; <script>document.write(new Date().getFullYear())</script>, made by <a href="">TI-165: Ion Doga</a>
                </div>
            </div>
        </footer>
